...
#
# $Revision: 7002 $
# $URL: svn://10.36.20.226/trunk/Web_Checks/XML_Validate/Tools/xml_text.pm $
# $Date: 2015-01-19 09:52:42 -0500 (Mon, 19 Jan 2015) $
#
# Description
#
#   This file contains routines to extract text from XML documents.
#
# Public functions:
#     XML_Text_Debug
#     XML_Text_Extract_Text
#     XML_Text_All_Language_Spans
#
#***********************************************************************
...
sub XML_Text_Extract_Text {
    ...
    if ( ! defined($input) || ($input eq "") ) {
        print "XML_Text_Extract_Text No content\n" if $debug;
    }
    print "XML_Text_Extract_Text_From_XML, content length = " . length($input) .
          "\n" if $debug;
    ...
    print "XML_Text_Extract_Text_From_XML, returned language = $primary_xml_lang, length = " .
          length($content) . "\n" if $debug;
...
#********************************************************
#
# Name: XML_Text_All_Language_Spans
#
# Parameters: none
#
# Description:
...
# text content from the previous call to XML_Text_Extract_Text.
#
# Returns:
#  language/text hash table
#
#********************************************************
sub XML_Text_All_Language_Spans {
